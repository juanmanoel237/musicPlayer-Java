...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Route vers l'enfer", 3.5);
        album.addSong("La Foudre", 5.0);
        albums.add(album);
        ...
        albums.get(0).addToPlayList("Route vers l'enfer",playList_1);
            ...
            switch (action){
                ...
                case 1:
                    ...
                    if(listIterator.hasNext()){
                        ...
                        System.out.println("No song avalaible, end of the list");
                        forward = false;
                    }
                    break;
                    case 2:
                    ...
                    if (forward){
                        if(listIterator.hasPrevious()){
                            ...
                            if (listIterator.hasNext()){
                                ...
                                System.out.print("We are at end of list");
                            }
                        }
                    break;
